      ...
      <nav className="p-4 border-b">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="bg-orange-600 text-white text-2xl font-bold px-3 py-2 rounded-lg">CS</div>
          ...
          <div className="hidden md:flex gap-4">
            <Link to="/" className="[&.active]:font-bold hover:text-orange-600 transition">
              Home
            </Link>
            <Link to="/services" className="[&.active]:font-bold hover:text-orange-600 transition">
              Services
            </Link>
          </div>
